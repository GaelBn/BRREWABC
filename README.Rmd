...
`"all"`. Stored objects are written to Parquet files under `res/parquet` and
...
> every tested particle, including rejected particles. This can generate many
> temporary Parquet fragments and require substantial disk space, memory, and
> consolidation time, especially when model outputs contain long trajectories
> or when the acceptance rate is low.
>
