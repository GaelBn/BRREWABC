...
- [`abcrejection()`](https://gaelbn.github.io/BRREWABC/reference/abcrejection.md)
...
- [`plot_densityridges()`](https://gaelbn.github.io/BRREWABC/reference/plot_densityridges.md)
  : Plot abcsmc results : densityridges for estimated parameters
- [`plot_distances()`](https://gaelbn.github.io/BRREWABC/reference/plot_distances.md)
  : Plot distribution of distances by model
- [`plot_ess()`](https://gaelbn.github.io/BRREWABC/reference/plot_ess.md)
