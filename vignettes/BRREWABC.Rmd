...
plot_abcsmc_res(data = all_accepted_particles, prior = PRIOR_DIST, filename = "smpl_pairplot_all.png", colorpal = "YlGnBu")
plot_densityridges(data = all_accepted_particles, prior = PRIOR_DIST, filename = "smpl_densityridges.png", colorpal = "YlGnBu")
plot_thresholds(data = all_thresholds, nb_threshold = 1, filename = "smpl_thresholds.png", colorpal = "YlGnBu")
```
