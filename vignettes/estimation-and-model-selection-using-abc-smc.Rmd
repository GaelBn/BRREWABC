...
plot_abcsmc_res(data = all_accepted_particles, prior = PRIOR_DIST, filename = "figures/mdlslctn_pairplot_all.png", colorpal = "YlGnBu")
plot_densityridges(data = all_accepted_particles, prior = PRIOR_DIST, filename = "figures/mdlslctn_densityridges.png", colorpal = "YlGnBu")
plot_thresholds(data = all_thresholds, nb_threshold = 1, filename = "figures/mdlslctn_thresholds.png", colorpal = "YlGnBu")
```
