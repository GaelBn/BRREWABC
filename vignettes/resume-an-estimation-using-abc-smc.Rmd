...
plot_abcsmc_res(data = all_accepted_particles, prior = prior_dist,
                filename = "rsmsmpl_pairplot_all.png", colorpal = "Greys")
plot_densityridges(data = all_accepted_particles, prior = prior_dist,
                   filename = "rsmsmpl_densityridges.png", colorpal = "Greys")
plot_thresholds(data = all_thresholds, nb_threshold = 1,
                filename = "rsmsmpl_thresholds.png", colorpal = "Greys")
```
...
all_thresholds <- res$thresholds
plot_abcsmc_res(data = all_accepted_particles, prior = prior_dist,
                filename = "rsmsmpl_pairplot_all_rsm.png", colorpal = "OrRd")
plot_densityridges(data = all_accepted_particles, prior = prior_dist,
                   filename = "rsmsmpl_densityridges_rsm.png",
                   colorpal = "OrRd")
plot_thresholds(data = all_thresholds, nb_threshold = 1,
                filename = "rsmsmpl_thresholds_rsm.png", colorpal = "OrRd")
```
